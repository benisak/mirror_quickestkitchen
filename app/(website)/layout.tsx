...
async function sharedMetaData(params: any) {
  ...
  return {
    ...
    title: {
      default:
        settings?.title ||
        "Quickest-recipes | Quick & Delicious Recipes for Busy Lives",
      template: "%s | Quickest-recipes | Quick & Delicious Recipes for Busy Lives"
    },
    description:
...
const siteUrl = "https://www.quickest-recipes.com/"; // Ensure this is correct
  ...
  return (
    <html
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            ...
            })(window,document,'script','dataLayer','GTM-5R934B83');`
          }}
        />
      ...
      <body className="text-gray-800 antialiased dark:bg-black dark:text-gray-400">
        ...
        <noscript>
          <iframe 
            src="https://www.googletagmanager.com/ns.html?id=GTM-5R934B83"
            height="0" 
            width="0" 
