...
const IngredientList: React.FC<IngredientListProps> = ({ ingredients }) => {
  ...
  return (
    <div className="mx-auto max-w-3xl p-0 ">
      ...
      <a
        href="#"
        className="bg-[#2d810d] border border-[#2d810d] text-white mt-4 hidden flex-[1_0_0] items-center justify-center gap-2 rounded-lg p-4 text-base font-semibold hover:bg-white hover:text-[#2d810d] hover:border-[#2d810d]
